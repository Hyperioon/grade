  ...
  methods: {
    onExport() {
      if (this.projectList.length > 0) {
        window.open(`/api/project/exportMyProjectExcel/?applyDepartment=${this.project.applyDepartment}&projectName=${this.project.projectName}&projectClass=${this.project.projectClass}&status=${this.project.status}`);
      } else {
